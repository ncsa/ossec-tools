...
# 2.) Check that all agents are connected except host1
# $ ./check_ossec.py -T connected --skip host1.blah.org

# 3.) Check that syscheck has been completed for all agents in the last 12 hours
# $ ./check_ossec.py -T syscheck -c 12 -w 6

# 4.) Check that rootkit checks have been completed for all agents in the last 3 hours
